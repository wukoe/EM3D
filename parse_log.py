...
import os
import re
import EMdetect.extract_seconds as es
import argparse
import csv
...
def parse_log(path_to_log):
    ...
    logfile_year = es.get_log_created_year(path_to_log)
    with open(path_to_log) as f:
        start_time = es.get_start_time(f, logfile_year)
        ...
        for line in f:
            ...
            time = es.extract_datetime_from_line(line,
                                                              logfile_year)
